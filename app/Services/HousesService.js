...
class HousesService {
  ...
  async addHouse(formData) {
    const response = await SandboxServer.post("/api/houses", formData)
  ...
  async editHouse(formData) {
    ...
    const response = await SandboxServer.put(`/api/houses/${activeHouse.id}`, formData)
  ...
  async deleteHouse(houseId) {
    await SandboxServer.delete(`/api/houses/${houseId}`)
